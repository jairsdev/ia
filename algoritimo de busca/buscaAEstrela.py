...
class Adjacente:
    def __init__(self, vertice, custo):
        ...
        self.custo = custo
        self.custoAEstrela = self.custo + self.vertice.distanciaObjetivo
    ...
    def buscar(self, atual):
        ...
        for adjacente in atual.adjacentes:
            if (adjacente.vertice.visitado == False):
                ...
                vetorOrdenado.inserir(adjacente)
        vetorOrdenado.imprimir()
        if (vetorOrdenado.valores[0].vertice == self.objetivo):
            self.encontrado = True
            return
        
        if (vetorOrdenado.valores[0] != None):
            self.buscar(vetorOrdenado.valores[0].vertice)
